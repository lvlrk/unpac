...
# Project:  unpac.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile unpac.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = unpac1.0.0
DISTDIR = /media/sdb1/Code/unpac/build/unpac1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=12 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -lfmt /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: unpac.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/main.cpp src/util.cpp src/filename.cpp src/bytestream.cpp src/my_file.cpp src/arcv.cpp $(DISTDIR)/
